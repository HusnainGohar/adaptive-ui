...
export default function App() {
  ...
  const renderCurrentView = () => {
    switch (currentView) {
      case "home":
        return (
          <Home onNavigate={handleNavigate} onProductClick={handleProductClick} onCategoryClick={handleCategoryClick} />
        )
      case "products":
        return <ProductList onProductClick={handleProductClick} selectedCategory={selectedCategory} />
      case "detail":
  ...
  return (
    ...
    <AuthProvider>
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="transition-all duration-500 ease-in-out">{renderCurrentView()}</main>
