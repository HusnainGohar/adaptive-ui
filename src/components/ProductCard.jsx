...
export default function ProductCard({ product, onClick }) {
        ...
        return (
          ...
          >
            <div className="relative">
              ...
              {product.onSale && (
                <div className="absolute top-2 left-2">
                  <span className="bg-red-500 text-white px-2 py-1 text-xs rounded-t">SAVE</span>
            ...
            <div className="p-4">
              ...
              <div className="text-sm text-green-600 font-medium mb-3">✓ Best Price Guarantee</div>
        ...
        return (
          ...
          >
            ...
            <div className="p-4">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{product.name}</h3>
              <div className="text-lg font-medium text-gray-900 mb-3">${product.price}</div>
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="text-sm text-orange-600 font-medium mb-3">
                🔥 Trending Now - {product.reviewCount} people bought this today!
              </div>
      ...
      case PERSONAS.LOYAL_CUSTOMER:
        return (
          ...
          >
            ...
            <div className="p-4">
              <div className="text-sm text-yellow-600 font-medium mb-1">⭐ Recommended for you</div>
              <h3 className="font-semibold text-gray-900 mb-2">{product.name}</h3>
              <div className="flex items-center gap-2 mb-3">
                <span className="text-lg font-bold text-gray-900">${product.price}</span>
                <span className="text-sm text-green-600 font-medium">+{Math.floor(product.price * 0.05)} points</span>
              </div>
              <div className="text-sm text-blue-600 mb-3">💎 Free shipping • Early access</div>
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="text-sm text-gray-600 mb-3">
                ...
                <div>📦 {product.specifications?.Warranty || "1 year"} warranty</div>
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="text-sm text-green-700 mb-3">
                {product.sustainability?.ethicalSourcing && <div>✓ Ethically sourced</div>}
                {product.sustainability?.recyclablePackaging && <div>✓ Recyclable packaging</div>}
                {product.sustainability?.organicMaterial && <div>✓ Organic materials</div>}
              </div>
              <div className="flex items-center gap-2 mb-3">
                <span className="text-lg font-bold text-gray-900">${product.price}</span>
              </div>
  ...
  return <div className="transition-all duration-500 ease-in-out">{renderByPersona()}</div>
}
